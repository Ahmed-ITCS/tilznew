...
# Add nested router for versions and branched episodes
version_router = DefaultRouter()
version_router.register(r'episodes', EpisodeViewSet, basename='branched-episode')
...
urlpatterns = [
    ...
    path('api/stories/<int:story_pk>/episodes/<int:episode_pk>/versions/<int:version_pk>/', include(version_router.urls)),
