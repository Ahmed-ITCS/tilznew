...
class StorySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'is_favorited', 'is_followed', 'likes_count', 'cover_image'  # Changed from cover_images to cover_image
        ]
...
class StoryCreateSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        # Remove any author data if it exists in validated_data
        validated_data.pop('author', None)
        # Get the author from the context
        author = self.context['request'].user
        # Create the story with the author
